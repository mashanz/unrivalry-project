...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, "unrivalryWeb/templates/web"),
            os.path.join(BASE_DIR, "unrivalryAdmin/templates"),
            os.path.join(BASE_DIR, "unrivalryAdmin/templates/adm"),
            os.path.join(BASE_DIR, "unrivalryApi/templates"),
            os.path.join(BASE_DIR, "unrivalryApi/templates/api"),
            os.path.join(BASE_DIR, "unrivalryDataScience/templates"),
            os.path.join(BASE_DIR, "unrivalryDataScience/templates/ds"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
